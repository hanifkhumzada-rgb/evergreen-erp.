...
export const getCurrentProfile = cache(async () => {
  ...
  // getClaims verifies the access token without a remote Auth user lookup.
  // This runs on every authenticated navigation, so avoiding that network
  // round-trip materially improves route-to-route latency.
