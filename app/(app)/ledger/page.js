...
import { KPI, Badge, ExportExcelButton, PrintButton, DownloadPdfButton, Th, Td } from "@/components/ui";
    ...
    <div>
      ...
      <div className="flex justify-between items-start mb-5 flex-wrap gap-3">
        ...
        <div className="no-print flex gap-2 flex-wrap">
          ...
          <ExportExcelButton rows={exportRows} sheetName="Statement" reportTitle={`${c.name} — Statement`} branding={branding} />
