...
const styles = StyleSheet.create({
  ...
  headerRow: { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 16, paddingBottom: 12, borderBottomWidth: 2, borderBottomColor: COLORS.navy },
  headerLeft: { width: 46 },
  logo: { width: 42, height: 42, borderRadius: 8 },
  headerCenter: { flex: 1, alignItems: "center", paddingHorizontal: 10 },
  brandName: { fontSize: 16, fontFamily: "Helvetica-Bold", color: COLORS.navy, letterSpacing: 0.6, textAlign: "center" },
