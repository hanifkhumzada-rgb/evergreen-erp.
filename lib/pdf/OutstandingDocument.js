...
export default function OutstandingDocument({ rows, totalOutstanding, businessName, address }) {
  return (
    <PdfShell title="Outstanding / Receivables Report" meta={fmtDate(new Date().toISOString())} businessName={businessName} address={address}>
