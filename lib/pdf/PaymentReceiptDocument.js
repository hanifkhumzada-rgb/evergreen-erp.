...
export default function PaymentReceiptDocument({ payment, customer, receivedBy, businessName, address }) {
  const amount = Number(payment.amount);
  return (
    <PdfShell title="Payment Receipt Voucher" meta={`${payment.receipt_no} · ${fmtDate(payment.payment_date)}`} businessName={businessName} address={address}>
      <VoucherInfo items={[
