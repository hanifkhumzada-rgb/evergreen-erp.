...
export default function CustomerStatementDocument({ customer, rows, openingBalance, totalDebit, totalCredit, closingBalance, branding }) {
  return (
    <PdfShell title="Client Account Statement" meta={`Period: All activity to date\nGenerated: ${fmtDate(new Date().toISOString())}`} branding={branding}>
