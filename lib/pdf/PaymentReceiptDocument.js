...
export default function PaymentReceiptDocument({ payment, customer, receivedBy, branding }) {
  const amount = Number(payment.amount);
  return (
    <PdfShell title="Payment Receipt Voucher" meta={`${payment.receipt_no} · ${fmtDate(payment.payment_date)}`} branding={branding}>
      <VoucherInfo items={[
