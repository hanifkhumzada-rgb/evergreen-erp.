...
export default async function NotificationsPage() {
  ...
  return (
    <div>
      ...
      <p className="text-slate text-sm mb-4">Stored in the database — visible to your role, not just your browser session. Low stock, high outstanding, bottle limit, bottle reconciliation shortages, unreconciled/damaged/lost bottle trends, and inactive-customer alerts are computed live from your real data.</p>
      ...
      <div className="overflow-x-auto border border-line rounded-2xl">
        <table className="w-full text-[13.5px] border-collapse">
          ...
          <tbody>
            {(notifications || []).length === 0 && <tr><td colSpan={4} className="text-center py-8 text-slate">No notifications yet. Tap &quot;Refresh Alerts&quot; to check for low stock, overdue payments, bottle limits, bottle reconciliation issues, and inactive customers.</td></tr>}
            {(notifications || []).map((n) => (
