...
export default function CustomerStatementDocument({ customer, rows, totalSales, totalPaid, balance, branding }) {
  return (
    <PdfShell title="Client Account Statement" meta={fmtDate(new Date().toISOString())} branding={branding}>
