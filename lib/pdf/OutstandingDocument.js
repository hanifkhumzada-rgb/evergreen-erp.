...
export default function OutstandingDocument({ rows, totalOutstanding, branding }) {
  return (
    <PdfShell title="Outstanding / Receivables Report" meta={fmtDate(new Date().toISOString())} branding={branding}>
