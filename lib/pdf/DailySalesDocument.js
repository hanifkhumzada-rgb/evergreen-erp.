...
export default function DailySalesDocument({ date, rows, totalAmount, businessName, address }) {
  return (
    <PdfShell title="Daily Sales Report" meta={fmtDate(date)} businessName={businessName} address={address}>
