  ...
  return (
    <form action={handleSubmit} className="border border-line rounded-2xl p-5 max-w-md">
      <label className="block mb-3">
        ...
        <input type="date" name="close_date" defaultValue={today} required className="w-full px-3 py-2 rounded-lg border border-line text-sm" />
      </label>
      <label className="block mb-3">
        <span className="text-xs font-semibold text-slate block mb-1">Opening cash (PKR)</span>
        <input type="number" name="opening_cash" defaultValue={defaultOpeningCash} required className="w-full px-3 py-2 rounded-lg border border-line text-sm" />
      </label>
      <label className="block mb-4">
        <span className="text-xs font-semibold text-slate block mb-1">Actual cash counted (PKR)</span>
        <input type="number" name="actual_cash" required className="w-full px-3 py-2 rounded-lg border border-line text-sm" />
      </label>
