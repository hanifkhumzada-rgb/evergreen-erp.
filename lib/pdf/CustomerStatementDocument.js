...
export default function CustomerStatementDocument({ customer, rows, totalSales, totalPaid, balance, businessName, address }) {
  return (
    <PdfShell title="Customer Statement" meta={fmtDate(new Date().toISOString())} businessName={businessName} address={address}>
